          ...
          {tiers.map((tier) => (
            <div
              ...
              className={cn(
                ...
                tier.popular
                  ? "border-violet-500 shadow-[0_25px_80px_-15px_rgba(139,92,246,0.35)] scale-105 z-10"
                  : "border-border shadow-xl hover:shadow-2xl hover:-translate-y-1",
              )}
            >
              {tier.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-5 py-1.5 bg-gradient-to-r from-violet-600 to-purple-600 text-white text-sm font-semibold rounded-full shadow-lg shadow-violet-500/30 flex items-center gap-2">
                  ...
                  <li key={feature} className="flex items-start gap-3 text-sm">
                    <div
                      className={cn(
                        ...
                        tier.popular ? "bg-violet-100 dark:bg-violet-950" : "bg-muted",
                      )}
                    >
                      <Check
                        className={cn("w-3.5 h-3.5", tier.popular ? "text-violet-600" : "text-muted-foreground")}
                      />
                    </div>
