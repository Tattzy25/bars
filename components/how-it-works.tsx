  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
            ...
            <div key={step.number} className="relative group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:flex absolute -right-4 lg:-right-5 top-1/2 -translate-y-1/2 z-10">
                  <div className="w-8 h-8 rounded-full bg-violet-100 dark:bg-violet-950 flex items-center justify-center shadow-md">
                    <ArrowRight className="w-4 h-4 text-violet-600 dark:text-violet-400" />
                  </div>
                </div>
              )}

              <div className="h-full p-6 lg:p-8 rounded-2xl border border-border bg-background hover:border-violet-300 dark:hover:border-violet-700 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                {/* Step number & icon */}
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-100 to-violet-200 dark:from-violet-950 dark:to-violet-900 flex items-center justify-center shadow-inner group-hover:shadow-lg group-hover:scale-110 transition-all duration-300">
                    <step.icon className="w-7 h-7 text-violet-600 dark:text-violet-400" />
                  </div>
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-600 to-purple-600 text-white text-lg font-bold flex items-center justify-center shadow-lg shadow-violet-500/30">
                    {step.number}
                  </div>
                </div>
        ...
        <div className="mt-16 relative rounded-3xl overflow-hidden shadow-[0_25px_80px_-15px_rgba(139,92,246,0.4)] dark:shadow-[0_25px_80px_-15px_rgba(139,92,246,0.2)]">
          ...
          <div className="relative p-8 lg:p-12 flex flex-col lg:flex-row items-center gap-8">
            <div className="flex-1 text-center lg:text-left">
              <h3 className="text-2xl lg:text-3xl font-bold text-white mb-4">See it in action</h3>
              ...
              <button className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-white text-violet-700 font-semibold hover:bg-violet-50 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 duration-300 group">
