  ...
  return (
    <section id="features" className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="relative rounded-3xl overflow-hidden mb-20 shadow-[0_25px_80px_-15px_rgba(0,0,0,0.2)] dark:shadow-[0_25px_80px_-15px_rgba(0,0,0,0.5)]">
          <div className="aspect-[21/9] relative">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-violet-950/95 via-violet-950/80 to-transparent" />
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group p-6 rounded-2xl border border-border bg-background hover:border-violet-300 dark:hover:border-violet-800 shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-violet-100 to-violet-200 dark:from-violet-950 dark:to-violet-900 flex items-center justify-center mb-5 shadow-inner group-hover:shadow-lg group-hover:scale-110 transition-all duration-300">
