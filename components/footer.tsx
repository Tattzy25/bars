      ...
      <div className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              size="lg"
              className="bg-gradient-to-r from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 text-white px-8 h-14 text-base rounded-xl shadow-xl shadow-violet-500/30 hover:shadow-2xl hover:shadow-violet-500/40 hover:-translate-y-0.5 transition-all duration-300 font-semibold group"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="px-8 h-14 text-base bg-background rounded-xl border-2 hover:border-violet-300 dark:hover:border-violet-700 shadow-lg hover:shadow-xl transition-all duration-300 font-semibold"
            >
              See Live Examples
            </Button>
          </div>
