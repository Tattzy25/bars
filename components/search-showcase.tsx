...
function FloatingBubble() {
  return (
    <div className="flex items-center justify-center h-full">
      <button className="w-16 h-16 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 text-white shadow-2xl shadow-violet-500/40 hover:shadow-violet-500/60 hover:scale-110 transition-all flex items-center justify-center">
  ...
  return (
    <div className="flex items-center justify-center h-full p-6">
      <div className="relative w-full max-w-md group">
        <div className="absolute -inset-1 bg-gradient-to-r from-violet-600 via-purple-600 to-pink-600 rounded-2xl opacity-75 group-hover:opacity-100 blur-sm transition duration-500 group-hover:blur" />
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4 p-6">
      ...
      <div className="flex items-center gap-2 flex-wrap justify-center">
        <span className="px-4 py-1.5 rounded-full bg-violet-100 dark:bg-violet-950 text-violet-700 dark:text-violet-300 text-sm font-medium flex items-center gap-1.5 shadow-md">
          <TagIcon className="w-3.5 h-3.5" /> Products
        </span>
        <span className="px-4 py-1.5 rounded-full bg-purple-100 dark:bg-purple-950 text-purple-700 dark:text-purple-300 text-sm font-medium flex items-center gap-1.5 shadow-md">
          <TagIcon className="w-3.5 h-3.5" /> Blog
        </span>
        <span className="px-4 py-1.5 rounded-full bg-pink-100 dark:bg-pink-950 text-pink-700 dark:text-pink-300 text-sm font-medium flex items-center gap-1.5 shadow-md">
  ...
  return (
    <div className="flex items-center justify-center h-full p-6">
      <div className="w-full max-w-md">
        <div className="flex items-center gap-3 pb-3 border-b-2 border-violet-600">
      ...
      <div
        className={cn(
          ...
          expanded
            ...
            : "p-4 bg-gradient-to-br from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 cursor-pointer shadow-xl shadow-violet-500/30",
        )}
      >
    ...
    <section id="styles" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-muted/30 via-muted/50 to-muted/30">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <span className="inline-block px-5 py-2 rounded-full bg-violet-100 dark:bg-violet-950/80 text-violet-700 dark:text-violet-300 text-sm font-semibold mb-6 shadow-lg shadow-violet-500/10 border border-violet-200 dark:border-violet-800">
            9 Stunning Styles
          </span>
            ...
            <button
              ...
              className={cn(
                ...
                activeStyle === style.id
                  ? "ring-4 ring-violet-500 shadow-2xl shadow-violet-500/30 scale-[1.02]"
                  : "ring-1 ring-border hover:ring-2 hover:ring-violet-400 dark:hover:ring-violet-600 shadow-lg hover:shadow-xl",
              )}
            >
              <div className="absolute inset-0">
                ...
                <div
                  className={cn(
                    ...
                    activeStyle === style.id
                      ? "bg-gradient-to-t from-violet-900/95 via-violet-900/60 to-violet-900/20"
                      : "bg-gradient-to-t from-zinc-900/90 via-zinc-900/50 to-transparent group-hover:from-violet-900/90 group-hover:via-violet-900/50",
                  )}
                />
              </div>
        ...
        <div className="relative bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-zinc-900 dark:via-zinc-900 dark:to-zinc-800 rounded-3xl border border-border shadow-[0_25px_80px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_25px_80px_-15px_rgba(0,0,0,0.5)] overflow-hidden">
          <div
